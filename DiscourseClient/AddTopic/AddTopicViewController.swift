...
class AddTopicViewController: UIViewController {
    ...
    fileprivate func showErrorValidatingNewTopicAlert(validateMessage: String) {
        let message = NSLocalizedString(validateMessage, comment: "")
        showAlert(message)
    }
...
extension AddTopicViewController: AddTopicViewDelegate {
    ...
    func errorValidatingNewTopic(validateMessage: String) {
        showErrorValidatingNewTopicAlert(validateMessage: validateMessage)
    }
}
